...
7. Optional: set `GEMINI_IMAGE_MODEL=gemini-3.1-flash-image-preview` in `backend/.env`
8. Run `npm install`
9. Run `npm run dev`
...
- Preferred Gemini image fallback model: `GEMINI_IMAGE_MODEL=gemini-3.1-flash-image-preview`
